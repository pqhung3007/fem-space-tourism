  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto lg:pl-32 pb-24 pt-32 lg:pt-48">
        <h1 className="text-indigo-100 uppercase text-lg lg:text-3xl tracking-[4px] font-sanCondensed pl-8 lg:pl-0 mb-8">
          ...
          <div className="flex flex-col lg:flex-row justify-center gap-12 lg:mr-20">
            ...
            <div className="flex justify-center lg:flex-col mt-8 space-x-4 lg:space-x-0 lg:space-y-8">
              {technologies.map((technology: Technology, index: number) => (
                <button
                  className={`flex justify-center items-center w-8 h-8 md:w-16 md:h-16 text-lg lg:text-xl font-serif rounded-full border border-white/20 hover:border-white duration-200 ${
                    order === index
                      ? "bg-white text-black"
            ...
            <div className="flex flex-col space-y-6 px-8 lg:px-0">
              <div className="text-center lg:text-left">
                ...
                <h2 className="font-serif text-white uppercase text-2xl lg:text-5xl mt-2">
                  {name}
                </h2>
              </div>
